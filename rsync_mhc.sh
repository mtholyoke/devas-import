...
LIBS_LOCAL_DIR=/mars/g/rch3/r/mdyar/jproctor-test/LIBS/MHC
...
XRF_LOCAL_DIR=/mars/g/rch3/r/mdyar/jproctor-test/XRF
XRF_REMOTE_DIR=/mars/g/rch3/r/mdyar/data_pXRF
# XRF_MASTER_FILE=

echo "Copying XRF files..."
...
cp "$XRF_REMOTE_DIR/tracer_17_csv/*" "$XRF_LOCAL_DIR/original/"
cp "$XRF_REMOTE_DIR/olympus_17_csv/*" "$XRF_LOCAL_DIR/original/"
# cp "$XRF_REMOTE_DIR/$XRF_MASTER_FILE" "$XRF_LOCAL_DIR"
echo "  done."
